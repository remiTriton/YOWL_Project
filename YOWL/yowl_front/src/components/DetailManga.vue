                ...
                >
                  <div class="u-container-layout u-container-layout-2">
                    ...
                    <h2 class="u-align-center u-blog-control u-text u-text-1">
                      <!--blog_post_header_content-->{{ anime.title
                    ...
                    <div class="u-blog-control u-metadata u-metadata-1">
                      ...
                      <span class="u-meta-date u-meta-icon"
                        ><!--blog_post_metadata_date_content-->From {{anime.aired.string}}
...
<div class="card" style="width: 18rem;">
        <div   class="card-body">
              <h5  class="card-title">{{ user.name }}</h5>  <h6 class="card-subtitle mb-2">{{com.created_at}}</h6>
              <p class="card-text">{{ com.content }}</p> 
   </div>
   <button type="button" class="btn btn-danger btn-sm">X</button>
               <button type="button" class="btn btn-success btn-sm">U</button>
          </div>
...
export default {
  ...
  created() {
    this.$store.dispatch("api/fetchAnAnime", this.$route.params.malId);
